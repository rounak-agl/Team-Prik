...
2. adjustment_pct — an integer % on base fare, 0..20 (increase-only). To price DOWN, step the classification down (adjustment stays 0).
...
{"decisions":[{"trip":<id>,"classification":"<tier>","adjustment_pct":<0-20>,"reason":"<=18 words"}]}
